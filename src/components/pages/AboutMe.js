            ...
            <div className='flex flex-col justify-between items-center overflow-y-auto overflow-x-hidden'>
                <div className='flex flex-col-reverse md:flex-row justify-evenly items-center mt-20'>
                    <div className='flex flex-col justify-evenly items-center md:items-start h-full'>
                        <h1 className='md:text-6xl text-5xl font-display m-10 md:m-0 md:animate-slideXL2'>Darryl Tillman</h1>
                        {/* TODO: Gradient Here */}
                    ...
                    <div className='w-2/3 md:w-1/4 flex justify-around md:animate-slideX3'>
                        ...
                        <img className='w-full rounded-full my-0 mx-auto' src={headshot} alt="Darryl Tillman" />
                    </div>
                </div>
                ...
                <div className='w-2/3 mt-20 mb-20 md:animate-slideX4'>
                    ...
                    <br /><br />
                    I want to bring my interests further into the internet age by creating useful websites for fans of those hobbies. I already made a <a className='text-highlight underline' href='https://Tales64.github.io/Trade-Wizard/' target='_blank' rel='noreferrer'>trade calculator for Magic the Gathering</a> and a <a className='text-highlight underline' href='https://Tales64.github.io/the-mortal-kingdoms/' target='_blank' rel='noreferrer'>wiki for my D&D campaign setting</a>. These are the types of websites I like to work on in my spare time but I also have a fascination for business and marketing that I like to exercise when building up someone else's brand.
                    <br /><br />
